...
Vue.component('DataTableSenate', {
    ...
    <select class="filter" v-model="state"  @change="select">
    <option v-for="option in options" v:bind:value = option.value>
        {{option.text}}
    </option>
    </select>
    ...
    data: function () {
        return {
            ...
            state: '',
            options: [
                { text: '--Choose a State--', state: '' },
                { text: 'Arkansas', state: 'AR' },
                { text: 'Arizona', state: 'AZ' },
                { text: 'Alabama', state: 'AL' },
                { text: 'California', state: 'CA' },
                { text: 'Colorado', state: 'CO' },
                { text: 'Connecticut', state: 'CT' },
