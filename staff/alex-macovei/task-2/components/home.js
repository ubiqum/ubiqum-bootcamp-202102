const Home = {
    ...
    <div class="col-sm-7">
      ...
      <a data-toggle="collapse" href="#history" aria-expanded="false" aria-controls="history">History</a>
    ...
    <div class="col-sm-5"> <img class="img-responsive" src="img/home-img.webp" alt="home-img"></div>
  </div>
