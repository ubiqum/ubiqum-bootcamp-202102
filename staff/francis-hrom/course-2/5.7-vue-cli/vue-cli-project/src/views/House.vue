...
<script>
import Congress from "@/components/Congress.vue";
...
export default {
  ...
  data() {
    return {
      type: "house",
      title: "Congressmen",
      description: `<p>The major power of the House is to pass federal legislation that
                    ...
                    <p>Each U.S. state is represented in the House in proportion to its
                    population as measured in the census, but every state is entitled to
                    at least one representative.</p>`,
    };
  },
};
</script>
